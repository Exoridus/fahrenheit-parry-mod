...
public sealed class TurnTimelineTracker {
    ...
    public void CorrelateDamageResolved(int targetSlot, DateTime timestampLocal, ulong frameIndex) {
        ...
        emit_event(
            ...
            timestampLocal,
            frameIndex,
            $"Damage resolved on target slot {targetSlot} while {active.Actor} is active.");
    }
