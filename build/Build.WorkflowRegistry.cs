...
internal sealed partial class BuildScript
{
    ...
    IReadOnlyList<WorkflowDefinition> CreateBuildWorkflowDefinitions()
    {
        ...
        [
            ...
            new("clean", "Core", "Remove local build/preflight outputs", "Remove generated local build outputs and preflight artifacts.", ["--full (optional)."], ["build.cmd clean", "build.cmd clean --full"], () => RunCleanCore(Full)),
    ...
    IReadOnlyList<WorkflowDefinition> CreateToolsWorkflowDefinitions()
    {
        ...
        [
            ...
            new("workspace-prune", "Tooling Workflows (local-only)", "Clean regenerable .workspace artifacts", "Remove regenerable local workspace artifacts using safe/deep presets.", ["--preset safe|deep (optional, default safe).", "--dry-run (optional)."], ["tools.cmd workspace-prune --preset safe --dry-run", "tools.cmd workspace-prune --preset deep"], WorkspacePruneCore),
